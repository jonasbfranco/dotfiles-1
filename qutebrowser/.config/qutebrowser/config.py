...
## Type: QtColor
c.colors.tabs.indicator.error = xresources['*.urgent']
...
c.fonts.monospace = '"Noto Sans Mono","xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal' 
...
## Type: Padding
c.tabs.indicator.padding = {'top': 10, 'bottom': 10, 'left': 2, 'right': 5}
